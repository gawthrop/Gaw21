...
def model():
    """ Acausal bond graph PIsl.py
    Created by stoichBondGraph at Wed Jan 27 12:36:58 2021

    Usage:
    import PIsl; model = PIsl.model()
    """

    model = bgt.new(name="PIsl")
    ### Species
    ...
    ### Ce:Inh to Re:con_I_Fwd_ecr_r0

    ## Bond from comp_Inh_jun to comp_con_I_Fwd_ecr_r0_junF
    bgt.connect(comp_Inh_jun,comp_con_I_Fwd_ecr_r0_junF)
    ...
    ### Ce:Inh to Re:con_P_Fwd_ecr_r0

    ## Bond from comp_Inh_jun to comp_con_P_Fwd_ecr_r0_junF
    bgt.connect(comp_Inh_jun,comp_con_P_Fwd_ecr_r0_junF)
    ...
    ### Re:con_I_Rev_ecr_r0 to Ce:Inh

    ## Bond from comp_con_I_Rev_ecr_r0_junR to comp_Inh_jun
    bgt.connect(comp_con_I_Rev_ecr_r0_junR,comp_Inh_jun)
    ...
    ### Re:con_P_Rev_ecr_r0 to Ce:Inh

    ## Bond from comp_con_P_Rev_ecr_r0_junR to comp_Inh_jun
    bgt.connect(comp_con_P_Rev_ecr_r0_junR,comp_Inh_jun)
